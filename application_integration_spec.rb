...
describe "GET '/' - Greeting Form" do
  ...
  # test what a user should see when they visit the greeting form, fill in a name, and click the 'Submit' button
  it 'greets the user personally based on their user_name in the form' do
    ...
    # When Capybara submits a form, the page object is updated
    # `page` no longer contains the original greeting form... after click_button is called, `page` now contains the response to the greeting form
